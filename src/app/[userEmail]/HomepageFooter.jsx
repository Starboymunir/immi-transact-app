...
export const HomepageFooter = () => {
    return (
        <div className="homepage-footer">
            ...
            <p className="p">
                Immi-Transact is not a law firm and does not provide legal advice. We connect individuals with licensed

                immigration attorneys for legal consultations and representation.
            </p>
